...
export default function UserColumn({ firstName, lastName, gender, imageId }) {
      ...
      <div className='flex'>
        <div className='flex-shrink-0 w-10 h-10'>
          <img
            ...
            src={`${CONSTANTS.THUMB.BASE_URL}thumb/${PizzaRestaurantHelper.genders[gender]}/${imageId}.jpg`}
            alt={fullName}
            title={fullName}
          />
        </div>
